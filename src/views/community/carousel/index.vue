  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" class="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="标题" prop="titleCn">
        <el-input v-model="queryParams.titleCn" placeholder="请输入标题" clearable size="small" @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="分类" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择分类" style="width: 120px" clearable="">
          <el-option v-for="dict in dict.type.carousel_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['community:carousel:add']">新增</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          type="success"
    ...
    <el-table v-loading="loading" :data="carouselList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片" align="center" prop="image" width="300">
        <template slot-scope="scope">
          ...
          <div label="图片" align="center" prop="image" width="300" v-else>
            <template>
              <el-image style="max-width: 50px; max-height: 50px" :src="scope.row.image">
              </el-image>
            </template>
          </div>
        </template>
      ...
      <el-table-column label="显示" align="center" prop="isSticky">
        <template slot-scope="scope">
          <el-switch v-model="scope.row.isDisplay" active-value="1" inactive-value="0" @change="handleDisplayChange(scope.row)"></el-switch>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['community:carousel:edit']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['community:carousel:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="50vw" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标题" prop="titleCn">
          <el-input type="textarea" autosize v-model="form.titleCn" placeholder="请输入标题" />
        </el-form-item>
        <el-form-item label="标题英文" prop="titleEn">
          <el-input type="textarea" autosize v-model="form.titleEn" placeholder="请输入标题" />
        </el-form-item>
        <!-- <el-form-item label="描述" prop="description">
          <el-input v-model="form.description" type="textarea" placeholder="请输入内容" />
        </el-form-item> -->
        <el-form-item label="描述中文" prop="descriptionCn">
          <el-input type="textarea" autosize v-model="form.descriptionCn" placeholder="请输入描述" />
        </el-form-item>
        <el-form-item label="描述英文" prop="descriptionEn">
          <el-input type="textarea" autosize v-model="form.descriptionEn" placeholder="请输入描述" />
        </el-form-item>

        <el-form-item label="描述2中文" prop="descriptionCn">
          <el-input type="textarea" autosize v-model="form.description2Cn" placeholder="请输入描述" />
        </el-form-item>
        <el-form-item label="描述2英文" prop="descriptionEn">
          <el-input type="textarea" autosize v-model="form.description2En" placeholder="请输入描述" />
        </el-form-item>
